javascript:function ctAddList(a) {
 ...
 if(_ctPage === "gc_map") { ctHdr = document.getElementById('uxLoginStatus_divSignedIn');}
 else if(_ctPage === "gc_map_new") {ctHdr = document.getElementsByClassName("profile-panel")[0].firstChild;}
 else if(_ctPage === "gc_geocache"){ ctHdr = document.getElementById('ctl00_uxLoginStatus_divSignedIn'); }
 else if(_ctPage === "pgc_map"){ ctHdr = document.getElementsByClassName('navbar-right')[0];}
